...
@RestControllerAdvice(assignableTypes = { ConversationSessionController.class, UserPreferenceController.class })
public class MemoryExceptionHandler {
    ...
    ResponseEntity<Map<String, Object>> unexpected(Exception exception) {
        return error(HttpStatus.SERVICE_UNAVAILABLE, "The conversation memory service is temporarily unavailable.");
    }
